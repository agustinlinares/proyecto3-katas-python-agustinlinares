...
- El código (nombres de funciones, variables, etc.) está en español, y el enunciado original de cada ejercicio se conserva en español dentro del docstring de cada función/clase.
